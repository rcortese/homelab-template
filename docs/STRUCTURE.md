...
| --- | --- | --- |
| `compose/` | Common Docker Compose anchors and instance compose files. | `docker-compose.common.yml` (when necessary) plus `docker-compose.<instance>.yml` for each instance. |
...
| `compose/docker-compose.common.yml` | Optional | Anchors and shared resources loaded before any instance file. |
