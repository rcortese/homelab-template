...
| --- | --- | --- |
| `compose/` | Base Docker Compose anchors. | `docker-compose.base.yml` (when necessary). Instance compose files now live at the repository root (`docker-compose.<instance>.yml`). |
