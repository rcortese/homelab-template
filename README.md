...
See the canonical dependency list in [`docs/ONBOARDING.md#1-install-the-base-dependencies`](docs/ONBOARDING.md#1-install-the-base-dependencies). Validate setup with `scripts/check_all.sh` (structure/env/compose checks using Docker and Compose).
